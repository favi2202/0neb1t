# CbS6 — Windows Security (Optional)

Status: **Reading** (5%). No practical task is marked complete.

## Scope

Windows Server, security policy, BitLocker, NTFS, Windows Firewall
...
secpol.txt, secpol_2.txt, crypt.txt, result.txt, firewall evidence
...
- Complete work in the assigned GitLab repository on `develop`.
...
Verify a personal computer meets the README requirements; do not use School 21 computers.
